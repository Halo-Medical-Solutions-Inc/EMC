    ...
    <>
      ...
      {inboxVisible && (
        <>
          ...
          />
          <div
            className="fixed left-[3rem] top-0 z-[70] h-screen overflow-hidden border-r border-neutral-200 bg-white shadow-md transition-[width] duration-200 ease-in-out"
